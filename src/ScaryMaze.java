...
int background = -15921909;
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("Copy of scream.wav"));
...
showScaryImage("6-evil-mc-donald.jpg");
	}
